...
exports.sign = function (options, callback) {
  var signOptions = _extends({}, options);
...
function spawnSign(options, callback) {
  ...
  var args = ['-in', options.path, '-out', outputPath, '-t', 'http://timestamp.verisign.com/scripts/timstamp.dll'];
...
function spawnVerify(options, callback) {
  var args = ['verify', '-in', options.path, '-require-leaf-hash', options.hash];
